...
SELECT customer.customer_id, customer.customer_last_name, customer.customer_first_name, SUM(CAST(customer_purchases.quantity AS FLOAT) * CAST(customer_purchases.cost_to_customer_per_qty AS FLOAT)) AS total_amount_spent
FROM customer
